...
import io.helidon.extensions.mcp.tests.common.RootsServer;
...
@ServerTest
class McpSdkStreamableRootTest extends AbstractMcpSdkTest {
    private final McpSyncClient client;

    McpSdkStreamableRootTest(WebServer server) {
