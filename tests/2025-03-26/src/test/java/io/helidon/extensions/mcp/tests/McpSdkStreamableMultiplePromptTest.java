...
import io.helidon.extensions.mcp.tests.common.MultiplePrompt;
...
@ServerTest
class McpSdkStreamableMultiplePromptTest extends AbstractMcpSdkTest {

    private final McpSyncClient client;

    McpSdkStreamableMultiplePromptTest(WebServer server) {
