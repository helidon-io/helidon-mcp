...
import io.helidon.extensions.mcp.tests.common.ConfigurationServer;
...
@ServerTest
class McpSdkStreamableConfigurationTest extends AbstractMcpSdkTest {

    private final McpSyncClient client;

    McpSdkStreamableConfigurationTest(WebServer server) {
        client = McpClient.sync(streamable(server.port(), "/config/path")).build();
    }
