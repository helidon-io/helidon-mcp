...
import io.helidon.extensions.mcp.tests.common.PaginationServer;
...
@ServerTest
class McpSdkStreamablePaginationTest extends AbstractMcpSdkTest {

    private final McpSyncClient client;

    McpSdkStreamablePaginationTest(WebServer server) {
        client = McpClient.sync(streamable(server.port(), "/pagination")).build();
        client.initialize();
    }
