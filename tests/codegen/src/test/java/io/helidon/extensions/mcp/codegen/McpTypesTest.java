...
class McpTypesTest {
    ...
    void testTypes() {
        ...
        checkField(toCheck, checked, fields, "LIST_MCP_RESOURCE_CONTENT", List.class);
        checkField(toCheck, checked, fields, "LIST_MCP_TOOL_CONTENT", List.class);
        checkField(toCheck, checked, fields, "LIST_MCP_PROMPT_CONTENT", List.class);
        checkField(toCheck, checked, fields, "MCP_COMPLETION_CONTENT", McpCompletionContent.class);
