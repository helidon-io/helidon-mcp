...
/**
 * Resource template server.
 */
public class MultipleResourceTemplate {
    /**
     * Resource URI 1.
     */
    public static final String RESOURCE1_URI = "https://{path}";
    /**
     * Resource URI 2.
     */
    public static final String RESOURCE2_URI = "https://{path}/{path}/{path}";
    /**
     * Resource URI 3.
     */
    public static final String RESOURCE3_URI = "https://{foo}/{bar}";
