...
public class McpWeather {
     ...
     * Server name.
     */
    public static final String SERVER_NAME = "mcp-server";
    /**
     * Tool name.
     */
     ...
     * Resource URI.
     */
    public static final String RESOURCE_URI = "file:///documents/alerts.txt";
    /**
     ...
     * Resource MIME type.
     */
    public static final MediaType RESOURCE_MIME_TYPE = MediaTypes.TEXT_PLAIN;
