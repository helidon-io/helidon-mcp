...
@ServerTest
class McpSdkSsePaginationTest extends AbstractMcpSdkTest {
    private final McpSyncClient client;

    McpSdkSsePaginationTest(WebServer server) {
        client = McpClient.sync(sse(server.port(), "/pagination")).build();
        client.initialize();
    }
